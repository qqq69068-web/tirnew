...
import { X, Send, Bot, ChevronDown, Loader2, Sparkles } from "lucide-react";
...
• підказати ціни
• допомогти записатися на ремонт
...
export default function AiChat() {
  ...
  const sendMessage = useCallback(async (text?: string) => {
    ...
    try {
      ...
      setMessages((prev) => [...prev, { role: "assistant", content: data.reply || "Вибачте, не вдалось отримати відповідь." }]);
    } catch {
