    ...
    <>
      ...
      <style>{`
        ...
        .services-hero__title {
          ...
          line-height: 1.1; color: var(--hero-text);
          margin-bottom: var(--space-3); letter-spacing: -0.01em;
        }
        .services-hero__sub {
          font-size: var(--text-sm); color: var(--hero-text-sub);
          max-width: 48ch; margin: 0 auto var(--space-6); line-height: 1.65;
        }
        ...
        .services-hero__stat {
          ...
          padding: var(--space-2) var(--space-5); gap: 2px;
        ...
        .services-tabs-bar__inner { display: flex; gap: 0; }
        .services-tab {
        ...
        .services-tab:hover { color: var(--text); background: var(--surface2); }
        .services-tab.active { color: var(--primary); border-bottom-color: var(--primary); }
        .services-tab__count {
        ...
        .service-row-v2:hover {
          background: var(--surface2); border-color: var(--border-accent);
        ...
        .service-row-v2__title {
          flex: 1; font-size: var(--text-sm); color: var(--text); font-weight: 500; line-height: 1.4;
        }
        ...
        .parts-banner:hover { background: var(--surface2); border-color: var(--border-accent); box-shadow: var(--shadow-sm); }
        .parts-banner__icon {
          width: 40px; height: 40px; border-radius: var(--radius);
          background: var(--primary-subtle); display: flex; align-items: center; justify-content: center;
          color: var(--accent); flex-shrink: 0; transition: background var(--transition-fast);
        }
        .parts-banner:hover .parts-banner__icon { background: rgba(15,118,110,0.18); }
        .parts-banner__body { flex: 1; min-width: 0; }
        .parts-banner__title { font-size: var(--text-sm); font-weight: 600; color: var(--text); margin-bottom: 2px; }
        .parts-banner__sub { font-size: var(--text-xs); color: var(--text-muted); line-height: 1.5; }
        .parts-banner__arrow {
          color: var(--text-faint); flex-shrink: 0;
          transition: transform var(--transition-spring), color var(--transition-fast);
        }
