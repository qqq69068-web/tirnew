  ...
  return (
    <>
      ...
      <style>{`
        ...
        /* ═══════════════════════════════════════════════
           LOCAL DARK STEEL PALETTE — only for /price
           Works regardless of user's light/dark theme
        ═══════════════════════════════════════════════ */
        .price-page {
          --p-bg:           #141618;   /* deep graphite */
          --p-surface:      #1c1f22;   /* steel plate */
          --p-surface2:     #22262a;   /* elevated surface */
          --p-surface3:     #282d32;   /* header rows */
          --p-border:       rgba(255,255,255,0.07);
          --p-border-strong:rgba(255,255,255,0.12);
          --p-text:         #e8eaec;   /* near-white */
          --p-text-muted:   #8f9499;   /* steel muted */
          --p-text-faint:   #535c63;   /* very dim */
          --p-accent:       #dc2626;   /* crimson */
        ...
        .price-rate-card {
          ...
          margin-top: 0.5rem;
          box-shadow: 0 0 0 1px rgba(220,38,38,0.08), 0 4px 16px rgba(0,0,0,0.3);
          width: fit-content;
        }
        ...
        .price-table-head {
          display: grid;
          grid-template-columns: 1fr 80px 130px 28px;
