...
export const services: ServiceItem[] = [
  ...
  },
  {
    ...
    title: "Підбір і замовлення запчастин",
    short: "Підбір та доставка оригінальних і якісних аналогів запчастин для вашого авто.",
    description:
      "Допомагаємо підібрати та замовити потрібні запчастини для легкових і вантажних автомобілів. Підбір за VIN-кодом, каталогом або артикулом. Оригінали та якісні аналоги з гарантією.",
    price: "За запитом",
    priceMin: 0,
    priceMax: 0,
    hours: "1–3 дні",
